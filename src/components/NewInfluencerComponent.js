      ...
      <Row className="mb-3">
        ...
        <Col md={4}>
          ...
          {selectedGenreName === "Chanson" && (
            <button onClick={handleTranslateClick}>Translate to English</button>
          )}
        </Col>
      </Row>
            ...
            {(() => {
              ...
              const topChorusInstrumentations =
                ...
                commonChorusInstrumentations.length
                  ? commonChorusInstrumentations
                      .filter((item) => item.type === "chorus_combination")
                      .slice(0, 1)
                  : [];
              const topBridgeInstrumentations =
                ...
                commonBridgeInstrumentations.length
                  ? commonBridgeInstrumentations
                      .filter((item) => item.type === "bridge_combination")
                      .slice(0, 1)
                  : [];
                ...
                if (
                  ...
                  tableRows.push(
                    <tr key={"common-" + i}>
                      ...
                      <td>
                        {topVerseLengths[i] ? topVerseLengths[i].name : null}
                      </td>
                      <td>
                        {topIntroLengths[i] ? topIntroLengths[i].name : null}
                      </td>
                      <td>
                        {topChorusLengths[i] ? topChorusLengths[i].name : null}
                      </td>
                      <td>
                        {topBridgeLengths[i] ? topBridgeLengths[i].name : null}
                      </td>
                      <td>
                        {topOutroLengths[i] ? topOutroLengths[i].name : null}
                      </td>
                      <td>
                        {topIntroInstrumentations[i]
                          ? topIntroInstrumentations[i].name
                      ...
                      <td>
                        {topInstruments[i] ? topInstruments[i].name : null}
                      </td>
                      <td>
                        {topIntroChords[i] ? topIntroChords[i].name : null}
                      </td>
                      <td>
                        {topVerseChords[i] ? topVerseChords[i].name : null}
                      </td>
                      <td>
                        {topChorusChords[i] ? topChorusChords[i].name : null}
                      </td>
                      <td>
                        {topBridgeChords[i] ? topBridgeChords[i].name : null}
                      </td>
                      <td>
                        {topOutroChords[i] ? topOutroChords[i].name : null}
                      </td>
                    </tr>
                  );
                }
